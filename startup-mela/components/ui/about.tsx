      ...
      <div className="max-w-6xl mx-auto relative z-10 flex flex-col gap-20">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="flex flex-col gap-6">
            <span className="text-[#014E87] text-lg font-bold tracking-[0.3em] uppercase ">
              E-Cell SMVIT
            </span>
            ...
            <p className="text-white/90 leading-relaxed text-lg md:text-base">
          ...
          <div className="flex flex-col gap-6">
            ...
            <h2 className="text-white text-2xl md:text-3xl font-semibold leading-snug">
              Two days to build, lead and shape the future
            </h2>
