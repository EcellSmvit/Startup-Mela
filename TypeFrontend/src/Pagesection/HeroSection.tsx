...
function HeroSection() {
    ...
    return (
        <div
            ref={sectionRef}
            className='bg-[#222831] w-screen h-screen flex items-center justify-center flex-col relative'
            style={{
        ...
        >
            ...
            <div className='flex items-center justify-center flex-col'>
                <h1 ref={textRef} className='text-[11rem] text-[#EEEEEE] font-bold'>
                    BIK<span className='z-20 relative leading-none'>E</span>SH
                </h1>
                <h1 ref={rightRef} className='text-[11rem] text-[#EEEEEE] font-bold'>
                    KU<span className='z-20 relative'>M</span>AR
                </h1>
            </div>
            ...
            <h1 className='font-sans text-[#222831] font-bold text-2xl p-2 bg-[#92F090]'>
